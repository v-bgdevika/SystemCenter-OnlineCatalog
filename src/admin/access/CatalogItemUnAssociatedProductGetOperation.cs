//-----------------------------------------------------------------------
// <copyright file="CatalogItemUnAssociatedProductGetOperation.cs" company="Microsoft Corporation">
...
namespace Microsoft.ManagementPackCatalog.Admin.Access
{
    ...
    /// <summary>
    /// This class is used to get the un associated product list for a CatalogItem
    /// </summary>
    public class CatalogItemUnAssociatedProductGetOperation : CatalogOperation
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the CatalogItemUnAssociatedProductGetOperation class.
        /// </summary>
        public CatalogItemUnAssociatedProductGetOperation()
            : base("CatalogItemUnAssociatedProductGet")
        {
