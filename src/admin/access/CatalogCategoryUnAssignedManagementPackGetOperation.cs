//-----------------------------------------------------------------------
// <copyright file="CatalogCategoryUnAssignedManagementPackGetOperation.cs" company="Microsoft Corporation">
...
namespace Microsoft.ManagementPackCatalog.Admin.Access
{
    ...
    /// <summary>
    /// This class is used to get CatalogManagementPack not assigned to a category 
    /// </summary>
    public class CatalogCategoryUnAssignedManagementPackGetOperation : CatalogOperation
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the CatalogCategoryUnAssignedManagementPackGetOperation class.
        /// </summary>
        public CatalogCategoryUnAssignedManagementPackGetOperation()
            : base("CatalogCategoryUnAssignedManagementPackGet")
        {
        ...
        /// </summary>
        /// <param name="categoryId">The category id whose unassigned MPs are to be retrieved.</param>
