...
namespace DLC_OCSync
{
    public class MsiToCategories
    {
        ...
        public MsiToCategories(string productId, string msiUrl, string catalogItemId, string categoryName, string languageId, string language)
        {
