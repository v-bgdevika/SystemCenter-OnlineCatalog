// -----------------------------------------------------------------------------------------
// <copyright company="Microsoft Corporation" file="EventSelectRulesViewCriteriaDialog.cs">
...
namespace Mom.Test.UI.Core.Console.Views.Events
{
    ...
    #region Interface Definition - IEventSelectRulesViewCriteriaDialogControls

    /// -----------------------------------------------------------------------------
    /// <summary>
    /// Interface definition, IEventSelectRulesViewCriteriaDialogControls, for EventSelectRulesViewCriteriaDialog.
    ...
    public interface IEventSelectRulesViewCriteriaDialogControls
    {
        /// <summary>
    ...
    /// </history>
    /// -----------------------------------------------------------------------------
    public class EventSelectRulesViewCriteriaDialog : Dialog, IEventSelectRulesViewCriteriaDialogControls
    {
        ...
        /// </summary>
        /// <param name='app'>
        /// Owner of EventSelectRulesViewCriteriaDialog of type ConsoleApp
        /// </param>
        /// <history>
        /// 	[lucyra] 08/11/2007 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        public EventSelectRulesViewCriteriaDialog(ConsoleApp app) : 
                base(app, Init(app))
        {
        ...
        #region IEventSelectRulesViewCriteriaDialog Controls Property
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        public virtual IEventSelectRulesViewCriteriaDialogControls Controls
        {
            get
            {
                return this;
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IEventSelectRulesViewCriteriaDialogControls.SelectAllButton
        {
            get
            {
                if ((this.cachedSelectAllButton == null))
                {
                    this.cachedSelectAllButton = new Button(this, EventSelectRulesViewCriteriaDialog.ControlIDs.SelectAllButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IEventSelectRulesViewCriteriaDialogControls.CancelButton
        {
            get
            {
                if ((this.cachedCancelButton == null))
                {
                    this.cachedCancelButton = new Button(this, EventSelectRulesViewCriteriaDialog.ControlIDs.CancelButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IEventSelectRulesViewCriteriaDialogControls.ClearAllButton
        {
            get
            {
                if ((this.cachedClearAllButton == null))
                {
                    this.cachedClearAllButton = new Button(this, EventSelectRulesViewCriteriaDialog.ControlIDs.ClearAllButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ListBox IEventSelectRulesViewCriteriaDialogControls.ListBox0
        {
            get
            {
                if ((this.cachedListBox0 == null))
                {
                    this.cachedListBox0 = new ListBox(this, EventSelectRulesViewCriteriaDialog.ControlIDs.ListBox0);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IEventSelectRulesViewCriteriaDialogControls.OKButton
        {
            get
            {
                if ((this.cachedOKButton == null))
                {
                    this.cachedOKButton = new Button(this, EventSelectRulesViewCriteriaDialog.ControlIDs.OKButton);
                }
        ...
        public class Strings
        {
            ...
            /// </remark>
            /// -----------------------------------------------------------------------------
            private const string ResourceDialogTitle = "Select Rules";
