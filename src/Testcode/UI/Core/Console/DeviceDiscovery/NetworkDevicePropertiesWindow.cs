// -----------------------------------------------------------------------------------------
// <copyright company="Microsoft Corporation" file="NetworkDevicePropertiesWindow.cs">
...
namespace Mom.Test.UI.Core.Console.DeviceDiscovery
{
    ...
    #region Interface Definition - INetworkDevicePropertiesWindowControls

    /// -----------------------------------------------------------------------------
    /// <summary>
    /// Interface definition, INetworkDevicePropertiesWindowControls, for NetworkDevicePropertiesWindow.
    ...
    public interface INetworkDevicePropertiesWindowControls
    {
        /// <summary>
    ...
    /// </history>
    /// -----------------------------------------------------------------------------
    public class NetworkDevicePropertiesWindow : Window, INetworkDevicePropertiesWindowControls
    {
        ...
        /// Owner of NetworkDevicePropertiesWindow of type Maui.Core.App
        /// </param>
        /// <history>
        /// 	[KellyMor] 28-Aug-05 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        public NetworkDevicePropertiesWindow(Maui.Core.App ownerWindow) : 
        ...
        #region INetworkDevicePropertiesWindow Controls Property
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        public virtual INetworkDevicePropertiesWindowControls Controls
        {
            get
            {
                return this;
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        TabControl INetworkDevicePropertiesWindowControls.Tab0TabControl
        {
            get
            {
                if ((this.cachedTab0TabControl == null))
                {
                    this.cachedTab0TabControl = new TabControl(this, NetworkDevicePropertiesWindow.ControlIDs.Tab0TabControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl INetworkDevicePropertiesWindowControls.TODOStaticControl
        {
            get
            {
                if ((this.cachedTODOStaticControl == null))
                {
                    this.cachedTODOStaticControl = new StaticControl(this, NetworkDevicePropertiesWindow.ControlIDs.TODOStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Toolbar INetworkDevicePropertiesWindowControls.ToolStrip1
        {
            get
            {
                if ((this.cachedToolStrip1 == null))
                {
                    this.cachedToolStrip1 = new Toolbar(this, NetworkDevicePropertiesWindow.ControlIDs.ToolStrip1);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button INetworkDevicePropertiesWindowControls.OkButton
        {
            get
            {
                if ((this.cachedOkButton == null))
                {
                    this.cachedOkButton = new Button(this, NetworkDevicePropertiesWindow.ControlIDs.OkButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button INetworkDevicePropertiesWindowControls.CancelButton
        {
            get
            {
                if ((this.cachedCancelButton == null))
                {
                    this.cachedCancelButton = new Button(this, NetworkDevicePropertiesWindow.ControlIDs.CancelButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button INetworkDevicePropertiesWindowControls.ApplyButton
        {
            get
            {
                if ((this.cachedApplyButton == null))
                {
                    this.cachedApplyButton = new Button(this, NetworkDevicePropertiesWindow.ControlIDs.ApplyButton);
                }
        ...
        public class Strings
        {
            ...
            /// </summary>
            /// -----------------------------------------------------------------------------
            private const string ResourceWindowTitle = ";Network Device/Other Computer Properties;ManagedString;Microsoft.EnterpriseManagement.UI.Administration.dll;" + 
                "Microsoft.EnterpriseManagement.Mom.Internal.UI.Administration.AdminResources;NetworkDevicePropertiesTitle";
