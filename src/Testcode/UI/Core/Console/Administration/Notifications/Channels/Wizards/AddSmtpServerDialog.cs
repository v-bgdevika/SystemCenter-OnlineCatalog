...
namespace Mom.Test.UI.Core.Console.Administration.Notifications.Channels.Wizards
{
    ...
    public class AddSmtpServerDialog : Dialog, IAddSmtpServerDialogControls
    {
        ...
        public virtual string AuthenticationMethodText
        {
            ...
            set
            {
                this.Controls.AuthenticationMethodComboBox.SelectByText(
                    value, 
                    true);
            }
        }
            ...
            get
            {
                if ((this.cachedOKButton == null))
                {
                    this.cachedOKButton = 
                        new Button(
                            this, 
                            AddSmtpServerDialog.ControlIDs.OKButton);
                }
            ...
            get
            {
                if ((this.cachedCancelButton == null))
                {
                    this.cachedCancelButton = 
                        new Button(
                            this, 
                            AddSmtpServerDialog.ControlIDs.CancelButton);
                }
        ...
        ComboBox IAddSmtpServerDialogControls.AuthenticationMethodComboBox
        {
            get
            {
                ...
                {
                    this.cachedAuthenticationMethodComboBox = 
                        new ComboBox(
                            this, 
                            AddSmtpServerDialog.ControlIDs.AuthenticationMethodComboBox);
                }
            ...
            get
            {
                if ((this.cachedPortNumberTextBox == null))
                {
                    this.cachedPortNumberTextBox = 
                        new TextBox(
                            this, 
                            AddSmtpServerDialog.ControlIDs.PortNumberTextBox);
                }
            ...
            get
            {
                if ((this.cachedAuthenticationMethodStaticControl == null))
                {
                    this.cachedAuthenticationMethodStaticControl = 
                        new StaticControl(
                            this, 
                            AddSmtpServerDialog.ControlIDs.AuthenticationMethodStaticControl);
                }
            ...
            get
            {
                if ((this.cachedPortNumberStaticControl == null))
                {
                    this.cachedPortNumberStaticControl = 
                        new StaticControl(
                            this, 
                            AddSmtpServerDialog.ControlIDs.PortNumberStaticControl);
                }
        ...
        TextBox IAddSmtpServerDialogControls.SMTPServerFQDNTextBox
        {
            get
            {
                ...
                {
                    this.cachedSMTPServerFQDNTextBox = 
                        new TextBox(
                            this, 
                            AddSmtpServerDialog.ControlIDs.SMTPServerFQDNTextBox);
                }
        ...
        StaticControl IAddSmtpServerDialogControls.SMTPServerFQDNStaticControl
        {
            get
            {
                ...
                {
                    this.cachedSMTPServerFQDNStaticControl = 
                        new StaticControl(
                            this, 
                            AddSmtpServerDialog.ControlIDs.SMTPServerFQDNStaticControl);
                }
        ...
        public class Strings
        {
            ...
            private const string ResourceDialogTitle = 
                ...
                ";Microsoft.EnterpriseManagement.Mom.Internal.UI.Notification.SmtpServerForm" +
                ";$this.Text";
            ...
            /// </summary>
            /// -------------------------------------------------------------------
            private const string ResourceSMTPServerFQDN =
                ";&SMTP server (FQDN):" +
                ";ManagedString" +
                ";Microsoft.MOM.UI.Components.dll" +
                ";Microsoft.EnterpriseManagement.Mom.Internal.UI.Notification.SmtpServerForm" +
            ...
            /// </summary>
            /// -------------------------------------------------------------------
            private const string ResourceNtlm =
                ";NTLM" +
                ";ManagedString" +
                ";Microsoft.MOM.UI.Components.dll" +
                ";Microsoft.EnterpriseManagement.Mom.Internal.UI.Notification.SmtpServerForm" +
                ";SmtpAuthenticationNTLM";
            ...
            /// </summary>
            /// -------------------------------------------------------------------
            private const string ResourceWindowsIntegrated =
                ";Windows Integrated" +
                ";ManagedString" +
                ";Microsoft.MOM.UI.Components.dll" +
                ";Microsoft.EnterpriseManagement.Mom.Internal.UI.Notification.NotificationResource" +
            ...
            public static string OK
            {
                get
                {
                    ...
                    {
                        cachedOK = 
                            CoreManager.MomConsole.GetIntlStr(ResourceOK);
                    }
            ...
            public static string Cancel
            {
                get
                {
                    ...
                    {
                        cachedCancel = 
                            CoreManager.MomConsole.GetIntlStr(ResourceCancel);
                    }
            ...
            public static string AuthenticationMethod
            {
                get
                {
                    ...
                    {
                        cachedAuthenticationMethod = 
                            CoreManager.MomConsole.GetIntlStr(
                                ResourceAuthenticationMethod);
                    }
            ...
            public static string SMTPServerFQDN
            {
                get
                {
                    ...
                    {
                        cachedSMTPServerFQDN = 
                            CoreManager.MomConsole.GetIntlStr(
                                ResourceSMTPServerFQDN);
                    }
            ...
            public static string WindowsIntegrated
            {
                get
                {
                    ...
                    {
                        cachedWindowsIntegrated = 
                            CoreManager.MomConsole.GetIntlStr(
                                ResourceWindowsIntegrated);
                    }
        ...
        public class ControlIDs
        {
            ...
            /// </summary>
            public const string AuthenticationMethodComboBox = 
                "authentication";
            ...
            /// </summary>
            public const string AuthenticationMethodStaticControl = 
                "authenticationLabel";
