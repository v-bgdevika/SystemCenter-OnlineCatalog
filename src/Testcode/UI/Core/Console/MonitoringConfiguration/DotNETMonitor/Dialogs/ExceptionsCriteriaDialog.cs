// -----------------------------------------------------------------------------------------
// <copyright company="Microsoft Corporation" file="ExceptionsCriteriaDialog.cs">
...
namespace Mom.Test.UI.Core.Console.MonitoringConfiguration.DotNETMonitor.Dialogs
{
    ...
    #region Interface Definition - IExceptionsCriteriaDialogControls

    /// -----------------------------------------------------------------------------
    /// <summary>
    /// Interface definition, IExceptionsCriteriaDialogControls, for ExceptionsCriteriaDialog.
    ...
    public interface IExceptionsCriteriaDialogControls
    {
        /// <summary>
        ...
        /// <summary>
        /// Read-only property to access ExceptionEventCountMonitoringStaticControl
        /// </summary>
        StaticControl ExceptionEventCountMonitoringStaticControl
        {
            get;
        }
        ...
        /// </summary>
        StaticControl IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA
        {
            get;
        }
        
        /// <summary>
        /// Read-only property to access EnableErrorExceptionCountMonitoringCheckBox
        /// </summary>
        CheckBox EnableErrorExceptionCountMonitoringCheckBox
        {
            get;
        }
        ...
        /// <summary>
        /// Read-only property to access ThresholdValuesComboBox
        /// </summary>
        EditComboBox ThresholdValuesComboBox
        {
            get;
        }
        ...
        /// <summary>
        /// Read-only property to access SpecifyExceptionCountMonitoringCriteriaStaticControl
        /// </summary>
        StaticControl SpecifyExceptionCountMonitoringCriteriaStaticControl
        {
            get;
        }
    }
    ...
    /// </history>
    /// -----------------------------------------------------------------------------
    public class ExceptionsCriteriaDialog : Dialog, IExceptionsCriteriaDialogControls
    {
        ...
        /// <summary>
        /// Cache to hold a reference to ExceptionEventCountMonitoringStaticControl of type StaticControl
        /// </summary>
        private StaticControl cachedExceptionEventCountMonitoringStaticControl;
        
        /// <summary>
        /// Cache to hold a reference to IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA of type StaticControl
        /// </summary>
        private StaticControl cachedIfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA;
        
        /// <summary>
        /// Cache to hold a reference to EnableErrorExceptionCountMonitoringCheckBox of type CheckBox
        /// </summary>
        private CheckBox cachedEnableErrorExceptionCountMonitoringCheckBox;
        ...
        /// </summary>
        private EditComboBox cachedComboBox0;
        ...
        /// <summary>
        /// Cache to hold a reference to ThresholdValuesComboBox of type ComboBox
        /// </summary>
        private EditComboBox cachedThresholdValuesComboBox;
        ...
        /// <summary>
        /// Cache to hold a reference to SpecifyExceptionCountMonitoringCriteriaStaticControl of type StaticControl
        /// </summary>
        private StaticControl cachedSpecifyExceptionCountMonitoringCriteriaStaticControl;
        #endregion
        ...
        /// </summary>
        /// <param name='app'>
        /// Owner of ExceptionsCriteriaDialog of type ConsoleApp
        /// </param>
        /// <history>
        /// 	[faizalk] 9/27/2006 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        public ExceptionsCriteriaDialog(ConsoleApp app) : 
                base(app, Init(app))
        {
        ...
        #region IExceptionsCriteriaDialog Controls Property
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        public virtual IExceptionsCriteriaDialogControls Controls
        {
            get
            {
                return this;
        ...
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Property to handle checkbox EnableErrorExceptionCountMonitoring
        /// </summary>
        /// <history>
        /// 	[faizalk] 9/27/2006 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        public virtual bool EnableErrorExceptionCountMonitoring
        {
            get
            {
                return this.Controls.EnableErrorExceptionCountMonitoringCheckBox.Checked;
            }
            
            set
            {
                this.Controls.EnableErrorExceptionCountMonitoringCheckBox.Checked = value;
            }
        }
        #endregion
        ...
        public virtual string ComboBox0Text
        {
            ...
            set
            {
                ...
                this.Controls.ComboBox0.Text = value;
            }
        }
        
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Routine to set/get the text in control ThresholdValues
        /// </summary>
        /// <value>TODO: specify the value</value>
        /// <history>
        /// 	[faizalk] 9/27/2006 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        public virtual string ThresholdValuesText
        {
            get
            {
                return this.Controls.ThresholdValuesComboBox.Text;
            }
            
            set
            {
                //this.Controls.ThresholdValuesComboBox.SelectByText(value, true);
                this.Controls.ThresholdValuesComboBox.Text = value;
            }
        }
        #endregion
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IExceptionsCriteriaDialogControls.PreviousButton
        {
            get
            {
                if ((this.cachedPreviousButton == null))
                {
                    this.cachedPreviousButton = new Button(this, ExceptionsCriteriaDialog.ControlIDs.PreviousButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IExceptionsCriteriaDialogControls.NextButton
        {
            get
            {
                if ((this.cachedNextButton == null))
                {
                    this.cachedNextButton = new Button(this, ExceptionsCriteriaDialog.ControlIDs.NextButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IExceptionsCriteriaDialogControls.CreateButton
        {
            get
            {
                if ((this.cachedCreateButton == null))
                {
                    this.cachedCreateButton = new Button(this, ExceptionsCriteriaDialog.ControlIDs.CreateButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IExceptionsCriteriaDialogControls.CancelButton
        {
            get
            {
                if ((this.cachedCancelButton == null))
                {
                    this.cachedCancelButton = new Button(this, ExceptionsCriteriaDialog.ControlIDs.CancelButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.MonitoringTypeStaticControl
        {
            get
            {
                if ((this.cachedMonitoringTypeStaticControl == null))
                {
                    this.cachedMonitoringTypeStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.MonitoringTypeStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.GeneralPropertiesStaticControl
        {
            get
            {
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.DiscoveryMethodStaticControl
        {
            get
            {
                // The ID for this control (textLinkLabel) is used multiple times in this dialog.
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.ASPNETApplicationStaticControl
        {
            get
            {
                // The ID for this control (textLinkLabel) is used multiple times in this dialog.
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.ExceptionsStaticControl
        {
            get
            {
                // The ID for this control (textLinkLabel) is used multiple times in this dialog.
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.PerformanceStaticControl
        {
            get
            {
                // The ID for this control (textLinkLabel) is used multiple times in this dialog.
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.SummaryStaticControl
        {
            get
            {
                // The ID for this control (textLinkLabel) is used multiple times in this dialog.
        ...
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Exposes access to the ExceptionEventCountMonitoringStaticControl control
        /// </summary>
        /// <history>
        /// 	[faizalk] 9/27/2006 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.ExceptionEventCountMonitoringStaticControl
        {
            get
            {
                if ((this.cachedExceptionEventCountMonitoringStaticControl == null))
                {
                    this.cachedExceptionEventCountMonitoringStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.ExceptionEventCountMonitoringStaticControl);
                }
                
                return this.cachedExceptionEventCountMonitoringStaticControl;
            }
        }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA
        {
            get
            {
                if ((this.cachedIfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA == null))
                {
                    this.cachedIfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA);
                }
        ...
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Exposes access to the EnableErrorExceptionCountMonitoringCheckBox control
        /// </summary>
        /// <history>
        /// 	[faizalk] 9/27/2006 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        CheckBox IExceptionsCriteriaDialogControls.EnableErrorExceptionCountMonitoringCheckBox
        {
            get
            {
                if ((this.cachedEnableErrorExceptionCountMonitoringCheckBox == null))
                {
                    this.cachedEnableErrorExceptionCountMonitoringCheckBox = new CheckBox(this, ExceptionsCriteriaDialog.ControlIDs.EnableErrorExceptionCountMonitoringCheckBox);
                }
                
                return this.cachedEnableErrorExceptionCountMonitoringCheckBox;
            }
        }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox IExceptionsCriteriaDialogControls.SampleTimeIntervalComboBox
        {
            get
            {
                if ((this.cachedSampleTimeIntervalComboBox == null))
                {
                    this.cachedSampleTimeIntervalComboBox = new ComboBox(this, ExceptionsCriteriaDialog.ControlIDs.SampleTimeIntervalComboBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        EditComboBox IExceptionsCriteriaDialogControls.IntervalComboBox
        {
            get
            {
                if ((this.cachedIntervalComboBox == null))
                {
                    this.cachedIntervalComboBox = new EditComboBox(this, ExceptionsCriteriaDialog.ControlIDs.IntervalComboBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.IntervalStaticControl
        {
            get
            {
                if ((this.cachedIntervalStaticControl == null))
                {
                    this.cachedIntervalStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.IntervalStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.NoteThisValueMustBeGreaterThanFirstThresholdStaticControl
        {
            get
            {
                if ((this.cachedNoteThisValueMustBeGreaterThanFirstThresholdStaticControl == null))
                {
                    this.cachedNoteThisValueMustBeGreaterThanFirstThresholdStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.NoteThisValueMustBeGreaterThanFirstThresholdStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.OccurrencesStaticControl
        {
            get
            {
                if ((this.cachedOccurrencesStaticControl == null))
                {
                    this.cachedOccurrencesStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.OccurrencesStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        EditComboBox IExceptionsCriteriaDialogControls.ComboBox0
        {
            get
            {
                if ((this.cachedComboBox0 == null))
                {
                    this.cachedComboBox0 = new EditComboBox(this, ExceptionsCriteriaDialog.ControlIDs.ComboBox0);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.ErrorThresholdStaticControl
        {
            get
            {
                if ((this.cachedErrorThresholdStaticControl == null))
                {
                    this.cachedErrorThresholdStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.ErrorThresholdStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.OccurrencesStaticControl2
        {
            get
            {
                if ((this.cachedOccurrencesStaticControl2 == null))
                {
                    this.cachedOccurrencesStaticControl2 = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.OccurrencesStaticControl2);
                }
        ...
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Exposes access to the ThresholdValuesComboBox control
        /// </summary>
        /// <history>
        /// 	[faizalk] 9/27/2006 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        EditComboBox IExceptionsCriteriaDialogControls.ThresholdValuesComboBox
        {
            get
            {
                if ((this.cachedThresholdValuesComboBox == null))
                {
                    this.cachedThresholdValuesComboBox = new EditComboBox(this, ExceptionsCriteriaDialog.ControlIDs.ThresholdValuesComboBox);
                }
                
                return this.cachedThresholdValuesComboBox;
            }
        }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.WarningThresholdStaticControl
        {
            get
            {
                if ((this.cachedWarningThresholdStaticControl == null))
                {
                    this.cachedWarningThresholdStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.WarningThresholdStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.SampleTimeIntervalStaticControl
        {
            get
            {
                if ((this.cachedSampleTimeIntervalStaticControl == null))
                {
                    this.cachedSampleTimeIntervalStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.SampleTimeIntervalStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.ThresholdValuesStaticControl
        {
            get
            {
                if ((this.cachedThresholdValuesStaticControl == null))
                {
                    this.cachedThresholdValuesStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.ThresholdValuesStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.HelpStaticControl
        {
            get
            {
                if ((this.cachedHelpStaticControl == null))
                {
                    this.cachedHelpStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.HelpStaticControl);
                }
        ...
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Exposes access to the SpecifyExceptionCountMonitoringCriteriaStaticControl control
        /// </summary>
        /// <history>
        /// 	[faizalk] 9/27/2006 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IExceptionsCriteriaDialogControls.SpecifyExceptionCountMonitoringCriteriaStaticControl
        {
            get
            {
                if ((this.cachedSpecifyExceptionCountMonitoringCriteriaStaticControl == null))
                {
                    this.cachedSpecifyExceptionCountMonitoringCriteriaStaticControl = new StaticControl(this, ExceptionsCriteriaDialog.ControlIDs.SpecifyExceptionCountMonitoringCriteriaStaticControl);
                }
                
                return this.cachedSpecifyExceptionCountMonitoringCriteriaStaticControl;
            }
        }
        #endregion
        ...
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Routine to click on button EnableErrorExceptionCountMonitoring
        /// </summary>
        /// <history>
        /// 	[faizalk] 9/27/2006 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        public virtual void ClickEnableErrorExceptionCountMonitoring()
        {
            this.Controls.EnableErrorExceptionCountMonitoringCheckBox.Click();
        }
        #endregion
        ...
        public class Strings
        {
            ...
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Contains resource string for:  ExceptionEventCountMonitoring
            /// </summary>
            /// <remark>
            /// TODO: DialogMaker could not find the resource for this string.  Find it and replace literal created by tool.
            /// </remark>
            /// -----------------------------------------------------------------------------
            private const string ResourceExceptionEventCountMonitoring = "Exception Event Count Monitoring";
            
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Contains resource string for:  IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA
            /// </summary>
            /// <remark>
            /// TODO: DialogMaker could not find the resource for this string.  Find it and replace literal created by tool.
            /// </remark>
            /// -----------------------------------------------------------------------------
            private const string ResourceIfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA = "If the rate of error exceptions, during a sampling interval exceeds the Warning o" +
                "r the Error thresholds, the state of the ASP.NET application changes.";
            
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Contains resource string for:  EnableErrorExceptionCountMonitoring
            /// </summary>
            /// <remark>
            /// TODO: DialogMaker could not find the resource for this string.  Find it and replace literal created by tool.
            /// </remark>
            /// -----------------------------------------------------------------------------
            private const string ResourceEnableErrorExceptionCountMonitoring = "E&nable Error exception count monitoring";
            ...
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Contains resource string for:  SpecifyExceptionCountMonitoringCriteria
            /// </summary>
            /// <remark>
            /// TODO: DialogMaker could not find the resource for this string.  Find it and replace literal created by tool.
            /// </remark>
            /// -----------------------------------------------------------------------------
            private const string ResourceSpecifyExceptionCountMonitoringCriteria = "Specify exception count monitoring criteria";
            #endregion
            ...
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Caches the translated resource string for:  ExceptionEventCountMonitoring
            /// </summary>
            /// -----------------------------------------------------------------------------
            private static string cachedExceptionEventCountMonitoring;
            
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Caches the translated resource string for:  IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA
            /// </summary>
            /// -----------------------------------------------------------------------------
            private static string cachedIfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA;
            
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Caches the translated resource string for:  EnableErrorExceptionCountMonitoring
            /// </summary>
            /// -----------------------------------------------------------------------------
            private static string cachedEnableErrorExceptionCountMonitoring;
            ...
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Caches the translated resource string for:  SpecifyExceptionCountMonitoringCriteria
            /// </summary>
            /// -----------------------------------------------------------------------------
            private static string cachedSpecifyExceptionCountMonitoringCriteria;
            #endregion
            ...
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Exposes access to the ExceptionEventCountMonitoring translated resource string
            /// </summary>
            /// <history>
            /// 	[faizalk] 9/27/2006 Created
            /// </history>
            /// -----------------------------------------------------------------------------
            public static string ExceptionEventCountMonitoring
            {
                get
                {
                    if ((cachedExceptionEventCountMonitoring == null))
                    {
                        cachedExceptionEventCountMonitoring = CoreManager.MomConsole.GetIntlStr(ResourceExceptionEventCountMonitoring);
                    }
                    
                    return cachedExceptionEventCountMonitoring;
                }
            }
            
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Exposes access to the IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA translated resource string
            /// </summary>
            /// <history>
            /// 	[faizalk] 9/27/2006 Created
            /// </history>
            /// -----------------------------------------------------------------------------
            public static string IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA
            {
                get
                {
                    if ((cachedIfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA == null))
                    {
                        cachedIfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA = CoreManager.MomConsole.GetIntlStr(ResourceIfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA);
                    }
                    
                    return cachedIfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA;
                }
            }
            
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Exposes access to the EnableErrorExceptionCountMonitoring translated resource string
            /// </summary>
            /// <history>
            /// 	[faizalk] 9/27/2006 Created
            /// </history>
            /// -----------------------------------------------------------------------------
            public static string EnableErrorExceptionCountMonitoring
            {
                get
                {
                    if ((cachedEnableErrorExceptionCountMonitoring == null))
                    {
                        cachedEnableErrorExceptionCountMonitoring = CoreManager.MomConsole.GetIntlStr(ResourceEnableErrorExceptionCountMonitoring);
                    }
                    
                    return cachedEnableErrorExceptionCountMonitoring;
                }
            }
            ...
            /// -----------------------------------------------------------------------------
            /// <summary>
            /// Exposes access to the SpecifyExceptionCountMonitoringCriteria translated resource string
            /// </summary>
            /// <history>
            /// 	[faizalk] 9/27/2006 Created
            /// </history>
            /// -----------------------------------------------------------------------------
            public static string SpecifyExceptionCountMonitoringCriteria
            {
                get
                {
                    if ((cachedSpecifyExceptionCountMonitoringCriteria == null))
                    {
                        cachedSpecifyExceptionCountMonitoringCriteria = CoreManager.MomConsole.GetIntlStr(ResourceSpecifyExceptionCountMonitoringCriteria);
                    }
                    
                    return cachedSpecifyExceptionCountMonitoringCriteria;
                }
            }
            #endregion
        }
        ...
        public class ControlIDs
        {
            ...
            /// <summary>
            /// Control ID for ExceptionEventCountMonitoringStaticControl
            /// </summary>
            public const string ExceptionEventCountMonitoringStaticControl = "pageSectionLabel1";
            
            /// <summary>
            /// Control ID for IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA
            /// </summary>
            public const string IfTheRateOfErrorExceptionsDuringASamplingIntervalExceedsTheWarningOrTheErrorThresholdsTheStateOfTheA = "label6";
            
            /// <summary>
            /// Control ID for EnableErrorExceptionCountMonitoringCheckBox
            /// </summary>
            public const string EnableErrorExceptionCountMonitoringCheckBox = "idCheckExceptions";
            ...
            /// </remark>
            public const string ComboBox0 = "idErrorThreshold";
            ...
            /// <summary>
            /// Control ID for ThresholdValuesComboBox
            /// </summary>
            public const string ThresholdValuesComboBox = "idWarningThreshold";
            ...
            /// <summary>
            /// Control ID for SpecifyExceptionCountMonitoringCriteriaStaticControl
            /// </summary>
            public const string SpecifyExceptionCountMonitoringCriteriaStaticControl = "headerLabel";
        }
        #endregion
    }
}
