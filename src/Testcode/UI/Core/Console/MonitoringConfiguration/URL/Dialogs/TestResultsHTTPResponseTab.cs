...
// </project>
// <summary>
// 	This class wraps HTTP Response tab.
// </summary>
// <history>
...
namespace Mom.Test.UI.Core.Console.MonitoringConfiguration.URL.Dialogs
{
    ...
    /// -----------------------------------------------------------------------------
    /// <summary>
    /// This class wraps HTTP Response tab. This tab contains the response from http request.
    /// </summary>
    /// <history>
    /// 	[v-bire] 3/15/2011 Created
    /// </history>
    /// -----------------------------------------------------------------------------
    public class TestResultsHTTPResponseTab
    {
        ...
        public TestResultsHTTPResponseTab(TabControlTab tab)
        {
            if (tab == null)
            {
