// -----------------------------------------------------------------------------------------
// <copyright company="Microsoft Corporation" file="ReportingUITestLinkedAlertsDialog.cs">
...
namespace Mom.Test.UI.Core.Console.Reporting.Dialogs
{
    ...
    #region Interface Definition - IReportingUITestLinkedAlertsDialogControls

    /// -----------------------------------------------------------------------------
    /// <summary>
    /// Interface definition, IReportingUITestLinkedAlertsDialogControls, for ReportingUITestLinkedAlertsDialog.
    ...
    public interface IReportingUITestLinkedAlertsDialogControls
    {
        /// <summary>
    ...
    /// </history>
    /// -----------------------------------------------------------------------------
    public class ReportingUITestLinkedAlertsDialog : Dialog, IReportingUITestLinkedAlertsDialogControls
    {
        ...
        /// </summary>
        /// <param name='app'>
        /// Owner of ReportingUITestLinkedAlertsDialog of type MomConsoleApp
        /// </param>
        /// <history>
        /// 	[a-omkasi] 7/23/2008 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        public ReportingUITestLinkedAlertsDialog(MomConsoleApp app) : 
                base(app, Init(app))
        {
        ...
        #region IReportingUITestLinkedAlertsDialog Controls Property
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        public virtual IReportingUITestLinkedAlertsDialogControls Controls
        {
            get
            {
                return this;
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IReportingUITestLinkedAlertsDialogControls.DataAggregationStaticControl
        {
            get
            {
                if ((this.cachedDataAggregationStaticControl == null))
                {
                    this.cachedDataAggregationStaticControl = new StaticControl(this, ReportingUITestLinkedAlertsDialog.ControlIDs.DataAggregationStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox IReportingUITestLinkedAlertsDialogControls.DataAggregationComboBox
        {
            get
            {
                if ((this.cachedDataAggregationComboBox == null))
                {
                    this.cachedDataAggregationComboBox = new ComboBox(this, ReportingUITestLinkedAlertsDialog.ControlIDs.DataAggregationComboBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IReportingUITestLinkedAlertsDialogControls.ObjectsStaticControl
        {
            get
            {
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        PropertyGridView IReportingUITestLinkedAlertsDialogControls._800AMTo500PMMonTueWedThuFriPropertyGridView
        {
            get
            {
                if ((this.cached_800AMTo500PMMonTueWedThuFriPropertyGridView == null))
                {
                    this.cached_800AMTo500PMMonTueWedThuFriPropertyGridView = new PropertyGridView(this, ReportingUITestLinkedAlertsDialog.ControlIDs._800AMTo500PMMonTueWedThuFriPropertyGridView);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IReportingUITestLinkedAlertsDialogControls.RemoveButton
        {
            get
            {
                if ((this.cachedRemoveButton == null))
                {
                    this.cachedRemoveButton = new Button(this, ReportingUITestLinkedAlertsDialog.ControlIDs.RemoveButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IReportingUITestLinkedAlertsDialogControls.AddObjectButton
        {
            get
            {
                if ((this.cachedAddObjectButton == null))
                {
                    this.cachedAddObjectButton = new Button(this, ReportingUITestLinkedAlertsDialog.ControlIDs.AddObjectButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IReportingUITestLinkedAlertsDialogControls.AddGroupButton
        {
            get
            {
                if ((this.cachedAddGroupButton == null))
                {
                    this.cachedAddGroupButton = new Button(this, ReportingUITestLinkedAlertsDialog.ControlIDs.AddGroupButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IReportingUITestLinkedAlertsDialogControls.StaticControl0
        {
            get
            {
                // The ID for this control (nameLabel) is used multiple times in this dialog.
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ListBox IReportingUITestLinkedAlertsDialogControls.ListBox
        {
            get
            {
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IReportingUITestLinkedAlertsDialogControls._800AMTo500PMMonTueWedThuFriStaticControl
        {
            get
            {
                if ((this.cached_800AMTo500PMMonTueWedThuFriStaticControl == null))
                {
                    this.cached_800AMTo500PMMonTueWedThuFriStaticControl = new StaticControl(this, ReportingUITestLinkedAlertsDialog.ControlIDs._800AMTo500PMMonTueWedThuFriStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        CheckBox IReportingUITestLinkedAlertsDialogControls.UseBusinessHoursCheckBox
        {
            get
            {
                if ((this.cachedUseBusinessHoursCheckBox == null))
                {
                    this.cachedUseBusinessHoursCheckBox = new CheckBox(this, ReportingUITestLinkedAlertsDialog.ControlIDs.UseBusinessHoursCheckBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Button IReportingUITestLinkedAlertsDialogControls.BusinessHoursButton
        {
            get
            {
                if ((this.cachedBusinessHoursButton == null))
                {
                    this.cachedBusinessHoursButton = new Button(this, ReportingUITestLinkedAlertsDialog.ControlIDs.BusinessHoursButton);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox IReportingUITestLinkedAlertsDialogControls.TimeZoneComboBox
        {
            get
            {
                if ((this.cachedTimeZoneComboBox == null))
                {
                    this.cachedTimeZoneComboBox = new ComboBox(this, ReportingUITestLinkedAlertsDialog.ControlIDs.TimeZoneComboBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IReportingUITestLinkedAlertsDialogControls.TimeZoneStaticControl
        {
            get
            {
                if ((this.cachedTimeZoneStaticControl == null))
                {
                    this.cachedTimeZoneStaticControl = new StaticControl(this, ReportingUITestLinkedAlertsDialog.ControlIDs.TimeZoneStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox IReportingUITestLinkedAlertsDialogControls.ToComboBox
        {
            get
            {
                if ((this.cachedToComboBox == null))
                {
                    this.cachedToComboBox = new ComboBox(this, ReportingUITestLinkedAlertsDialog.ControlIDs.ToComboBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Spinner IReportingUITestLinkedAlertsDialogControls.ToSpinner
        {
            get
            {
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox IReportingUITestLinkedAlertsDialogControls.FromComboBox
        {
            get
            {
                if ((this.cachedFromComboBox == null))
                {
                    this.cachedFromComboBox = new ComboBox(this, ReportingUITestLinkedAlertsDialog.ControlIDs.FromComboBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Spinner IReportingUITestLinkedAlertsDialogControls.FromSpinner
        {
            get
            {
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox IReportingUITestLinkedAlertsDialogControls.FromComboBox2
        {
            get
            {
                if ((this.cachedFromComboBox2 == null))
                {
                    this.cachedFromComboBox2 = new ComboBox(this, ReportingUITestLinkedAlertsDialog.ControlIDs.FromComboBox2);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox IReportingUITestLinkedAlertsDialogControls.ToComboBox2
        {
            get
            {
                if ((this.cachedToComboBox2 == null))
                {
                    this.cachedToComboBox2 = new ComboBox(this, ReportingUITestLinkedAlertsDialog.ControlIDs.ToComboBox2);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IReportingUITestLinkedAlertsDialogControls.FromStaticControl
        {
            get
            {
                if ((this.cachedFromStaticControl == null))
                {
                    this.cachedFromStaticControl = new StaticControl(this, ReportingUITestLinkedAlertsDialog.ControlIDs.FromStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl IReportingUITestLinkedAlertsDialogControls.ToStaticControl
        {
            get
            {
                if ((this.cachedToStaticControl == null))
                {
                    this.cachedToStaticControl = new StaticControl(this, ReportingUITestLinkedAlertsDialog.ControlIDs.ToStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StatusBar IReportingUITestLinkedAlertsDialogControls._800AMTo500PMMonTueWedThuFriStatusBar
        {
            get
            {
                if ((this.cached_800AMTo500PMMonTueWedThuFriStatusBar == null))
                {
                    this.cached_800AMTo500PMMonTueWedThuFriStatusBar = new StatusBar(this, ReportingUITestLinkedAlertsDialog.ControlIDs._800AMTo500PMMonTueWedThuFriStatusBar);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Toolbar IReportingUITestLinkedAlertsDialogControls.Toolbar1
        {
            get
            {
                if ((this.cachedToolbar1 == null))
                {
                    this.cachedToolbar1 = new Toolbar(this, ReportingUITestLinkedAlertsDialog.ControlIDs.Toolbar1);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        TextBox IReportingUITestLinkedAlertsDialogControls.TextBox2
        {
            get
            {
            ...
            catch (Exceptions.WindowNotFoundException )
            {
                            ...
                            && (numberOfTries < maxTries)); numberOfTries = (numberOfTries + 1))
                {
                    ...
                    catch (Exceptions.WindowNotFoundException )
                    {
                        ...
                        Mom.Test.UI.Core.Common.Utilities.LogMessage("Reporting.Dialogs.ReportUITestLinkedAlertsDialog :: Attempt " + numberOfTries + " of " + maxTries);
                    ...
                    catch (Maui.GlobalExceptions.TimedOutException)
                    {
                        ...
                        Mom.Test.UI.Core.Common.Utilities.LogMessage("Reporting.Dialogs.ReportUITestLinkedAlertsDialog :: Absorbing TimedOutException-" + numberOfTries + "! The ReportUITestLinkedAlertsDialog Dialog window is taking too long to render.");
                    }
                }
        ...
        public class Strings
        {
            ...
            public static string DialogTitle
            {
                get
                {
                    ...
                    {
                        throw new Maui.GlobalExceptions.MauiException("Exception in getting Dialog Title for ReportingUITestLinkedAlerts Dialog! Cannot use ReportDisplayName as it is null!");
                    }
        ...
        public class ControlIDs
        {
            ...
            /// </remark>
            public const string StaticControl0 = "nameLabel";
