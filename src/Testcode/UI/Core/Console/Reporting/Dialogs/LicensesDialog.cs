// -----------------------------------------------------------------------------------------
// <copyright company="Microsoft Corporation" file="LicensesDialog.cs">
...
namespace Mom.Test.UI.Core.Console.Reporting.Dialogs
{
    ...
    #region Interface Definition - ILicensesDialogControls

    /// -----------------------------------------------------------------------------
    /// <summary>
    /// Interface definition, ILicensesDialogControls, for LicensesDialog.
    ...
    public interface ILicensesDialogControls
    {
        /// <summary>
        ...
        /// <summary>
        /// Read-only property to access Toolbar28
        /// </summary>
        /// <remark>
        ...
        /// <summary>
        /// Read-only property to access TextBox29
        /// </summary>
        /// <remark>
        /// TODO: Rename this interface method.  Intuitive name not found by Class Maker Tool.
        /// </remark>
    ...
    /// </history>
    /// -----------------------------------------------------------------------------
    public class LicensesDialog : Dialog, ILicensesDialogControls
    {
        ...
        /// <summary>
        /// Cache to hold a reference to Toolbar28 of type Toolbar
        /// </summary>
        private Toolbar cachedToolbar28;
        
        /// <summary>
        /// Cache to hold a reference to TextBox29 of type TextBox
        /// </summary>
        private TextBox cachedTextBox29;
        #endregion
        ...
        /// </summary>
        /// <param name='app'>
        /// Owner of LicensesDialog of type MomConsoleApp
        /// </param>
        /// <history>
        /// 	[a-omkasi] 7/24/2008 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        public LicensesDialog(MomConsoleApp app) : 
                base(app, Init(app))
        {
        ...
        #region ILicensesDialog Controls Property
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        public virtual ILicensesDialogControls Controls
        {
            get
            {
                return this;
        ...
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Routine to set/get the text in control TextBox29
        /// </summary>
        /// <value>TODO: specify the value</value>
        /// <history>
        /// 	[a-omkasi] 7/24/2008 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        public virtual string TextBox29Text
        {
            get
            {
                return this.Controls.TextBox29.Text;
            }
            
            set
            {
                this.Controls.TextBox29.Text = value;
            }
        }
        #endregion
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox ILicensesDialogControls.DataAggregationComboBox
        {
            get
            {
                if ((this.cachedDataAggregationComboBox == null))
                {
                    this.cachedDataAggregationComboBox = new ComboBox(this, LicensesDialog.ControlIDs.DataAggregationComboBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl ILicensesDialogControls.TimeZoneStaticControl
        {
            get
            {
                if ((this.cachedTimeZoneStaticControl == null))
                {
                    this.cachedTimeZoneStaticControl = new StaticControl(this, LicensesDialog.ControlIDs.TimeZoneStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox ILicensesDialogControls.ToComboBox
        {
            get
            {
                if ((this.cachedToComboBox == null))
                {
                    this.cachedToComboBox = new ComboBox(this, LicensesDialog.ControlIDs.ToComboBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Spinner ILicensesDialogControls.ToSpinner
        {
            get
            {
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox ILicensesDialogControls.FromComboBox
        {
            get
            {
                if ((this.cachedFromComboBox == null))
                {
                    this.cachedFromComboBox = new ComboBox(this, LicensesDialog.ControlIDs.FromComboBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        Spinner ILicensesDialogControls.FromSpinner
        {
            get
            {
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox ILicensesDialogControls.FromComboBox2
        {
            get
            {
                if ((this.cachedFromComboBox2 == null))
                {
                    this.cachedFromComboBox2 = new ComboBox(this, LicensesDialog.ControlIDs.FromComboBox2);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ComboBox ILicensesDialogControls.ToComboBox2
        {
            get
            {
                if ((this.cachedToComboBox2 == null))
                {
                    this.cachedToComboBox2 = new ComboBox(this, LicensesDialog.ControlIDs.ToComboBox2);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl ILicensesDialogControls.FromStaticControl
        {
            get
            {
                if ((this.cachedFromStaticControl == null))
                {
                    this.cachedFromStaticControl = new StaticControl(this, LicensesDialog.ControlIDs.FromStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl ILicensesDialogControls.ToStaticControl
        {
            get
            {
                if ((this.cachedToStaticControl == null))
                {
                    this.cachedToStaticControl = new StaticControl(this, LicensesDialog.ControlIDs.ToStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StaticControl ILicensesDialogControls.ManagementGroupStaticControl
        {
            get
            {
                if ((this.cachedManagementGroupStaticControl == null))
                {
                    this.cachedManagementGroupStaticControl = new StaticControl(this, LicensesDialog.ControlIDs.ManagementGroupStaticControl);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        ListBox ILicensesDialogControls.DataAggregationListBox
        {
            get
            {
                if ((this.cachedDataAggregationListBox == null))
                {
                    this.cachedDataAggregationListBox = new ListBox(this, LicensesDialog.ControlIDs.DataAggregationListBox);
                }
        ...
        /// </history>
        /// -----------------------------------------------------------------------------
        StatusBar ILicensesDialogControls._800AMTo500PMMonTueWedThuFriStatusBar
        {
            get
            {
                if ((this.cached_800AMTo500PMMonTueWedThuFriStatusBar == null))
                {
                    this.cached_800AMTo500PMMonTueWedThuFriStatusBar = new StatusBar(this, LicensesDialog.ControlIDs._800AMTo500PMMonTueWedThuFriStatusBar);
                }
        ...
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Exposes access to the Toolbar28 control
        /// </summary>
        /// <history>
        /// 	[a-omkasi] 7/24/2008 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        Toolbar ILicensesDialogControls.Toolbar28
        {
            get
            {
                if ((this.cachedToolbar28 == null))
                {
                    this.cachedToolbar28 = new Toolbar(this, LicensesDialog.ControlIDs.Toolbar28);
                }
                return this.cachedToolbar28;
            }
        }
        
        /// -----------------------------------------------------------------------------
        /// <summary>
        ///  Exposes access to the TextBox29 control
        /// </summary>
        /// <history>
        /// 	[a-omkasi] 7/24/2008 Created
        /// </history>
        /// -----------------------------------------------------------------------------
        TextBox ILicensesDialogControls.TextBox29
        {
            get
            {
                if ((this.cachedTextBox29 == null))
                {
                    Window wndTemp = this;
                    // Required to navigate to control
                    wndTemp = wndTemp.Extended.FirstChild;
                    ...
                    wndTemp = wndTemp.Extended.FirstChild;
                    this.cachedTextBox29 = new TextBox(wndTemp);
                }
                return this.cachedTextBox29;
            }
        }
        #endregion
        ...
        public class Strings
        {
            ...
            /// </remark>
            /// -----------------------------------------------------------------------------
            private const string ResourceDialogTitle = "Licenses - System Center Operations Manager 2007 - Report - hornet245d";
            ...
            public static string DialogTitle
            {
                get
                {
                    ...
                    {
                        throw new Maui.GlobalExceptions.MauiException("Exception in getting Dialog Title for Licenses Dialog! Cannot use ReportDisplayName as it is null!");
                    }
        ...
        public class ControlIDs
        {
            ...
            /// <summary>
            /// Control ID for Toolbar28
            /// </summary>
            /// <remark>
            ///  TODO: You may wish to rename this ID.  Intuitive name not found by Dialog Class Maker
            /// </remark>
            public const string Toolbar28 = "toolBar";
        }
        #endregion
    }
}
