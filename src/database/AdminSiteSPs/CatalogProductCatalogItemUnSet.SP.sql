IF NOT EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'CatalogProductCatalogItemUnSet')
  BEGIN
    EXECUTE ('CREATE PROCEDURE CatalogProductCatalogItemUnSet AS RETURN 1')
  END
GO

GRANT EXECUTE ON CatalogProductCatalogItemUnSet TO "SystemCenter_admin"
GO

ALTER PROC dbo.CatalogProductCatalogItemUnSet
(
   @CatalogItemId            int
  ,@ProductId                int
)
