//-----------------------------------------------------------------------
// <copyright file="CatalogManagementPackCategoryUnSetOperation.cs" company="Microsoft Corporation">
...
namespace Microsoft.ManagementPackCatalog.Admin.Access
{
    ...
    /// <summary>
    /// This class is used to remove management pack to a category information
    /// </summary>
    public class CatalogManagementPackCategoryUnSetOperation : CatalogOperation
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the CatalogManagementPackCategoryUnSetOperation class.
        /// </summary>
        public CatalogManagementPackCategoryUnSetOperation()
            : base("CatalogManagementPackCategoryUnSet")
        {
        }
