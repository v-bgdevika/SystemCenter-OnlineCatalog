//-----------------------------------------------------------------------
// <copyright file="CatalogProductCatalogItemUnSetOperation.cs" company="Microsoft Corporation">
...
namespace Microsoft.ManagementPackCatalog.Admin.Access
{
    ...
    /// <summary>
    /// This class is used to remove catalog item to a product
    /// </summary>
    public class CatalogProductCatalogItemUnSetOperation : CatalogOperation
    {
        /// <summary>
        ...
        /// </summary>
        public CatalogProductCatalogItemUnSetOperation()
            : base("CatalogProductCatalogItemUnSet")
        {
        }
